    ...
    <div className="h-full w-full max-w-full rounded-xl border border-slate-200 bg-white p-3 sm:p-4 flex flex-col shadow-card min-w-0 overflow-hidden">
      <div className="mb-2">
        ...
        <p className="text-[11px] sm:text-xs text-slate-500 mt-0.5">
          Bars = passengers expected in that 1-hour window (SETC × 45 + other corps × 65). Orange
          line = minimum MTC Buses required (passengers ÷ 75 + 20% buffer). Number under each hour
          = inbound buses.
        </p>
